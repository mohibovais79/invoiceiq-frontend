        ...
        <main className="min-h-screen w-full flex flex-col lg:flex-row bg-canvas selection:bg-brand-subtle selection:text-brand-primary">
            ...
            <div className="w-full lg:w-[50%] xl:w-[45%] flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12 bg-surface relative z-10 shadow-elevated">
                ...
                <div className="w-full max-w-[400px] mx-auto mt-12 lg:mt-0">
                    ...
                    >
                        <h1 className="text-[24px] font-bold text-ink mb-2">Welcome back</h1>
                        <p className="text-[14px] text-slate mb-8">Log in to your workspace</p>
                    </motion.div>
                    ...
                    >
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            {/* Forgot Password Link - Exactly 13px, right-aligned */}
                            <div className="flex justify-end pt-1 pb-2">
                                <Link
                                    href="/forgot-password"
                                    className="text-[13px] text-brand-primary font-medium hover:text-brand-hover hover:underline underline-offset-2 transition-colors"
                                >
                                    Forgot password?
                                </Link>
                            </div>
                        ...
                        <p className="text-center text-sm text-slate mt-8">
                            ...
                            <Link href="/signup" className="text-brand-primary font-medium hover:text-brand-hover underline-offset-2 hover:underline">
                                Sign up
                            </Link>
                        </p>
                    </motion.div>
            ...
            {/* RIGHT SIDE: Visual/Value Prop (bg-canvas) - EXACT MATCH TO SIGNUP */}
